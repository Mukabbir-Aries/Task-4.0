                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <form method="POST" class="inline-block">
                                            ...
                                            <?php if ($user['status'] === 'active'): ?>
                                                <button type="submit" name="action" value="deactivate" class="text-red-600 hover:text-red-900">Deactivate</button>
                                            <?php else: ?>
                                                <button type="submit" name="action" value="activate" class="text-green-600 hover:text-green-900">Activate</button>
                                            <?php endif; ?>
                                        </form>
                                        <a href="view_user.php?id=<?php echo $user['id']; ?>" class="text-blue-600 hover:text-blue-900 ml-4">View Details</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
