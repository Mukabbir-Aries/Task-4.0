                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="../Admin/admindashboard.php"><i class="fas fa-tachometer-alt mr-2"></i>Admin Dashboard</a>
                            <a href="../Admin/manage_users.php"><i class="fas fa-users mr-2"></i>Manage Users</a>
                            <a href="../Admin/manage_surveys.php"><i class="fas fa-poll mr-2"></i>Manage Surveys</a>
                            <a href="../Admin/admin_withdrawals.php"><i class="fas fa-money-bill-wave mr-2"></i>Manage Withdrawals</a>
                        </div>
                    </div>
                </div>
            </div>
